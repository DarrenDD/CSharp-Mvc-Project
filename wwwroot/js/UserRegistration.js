$(function () {
    ...
    $("#UserRegistrationModal").on('hidden.bs.modal', function (e) {
        $("#UserRegistrationModal input[name='ProgrammeId']").val('0');
    });

    $('.RegisterLink').click(function () {

        $("#UserRegistrationModal input[name='ProgrammeId']").val($(this).attr('data-programmeId'));
    ...
    function onUserRegisterClick() {
        ...
        var programmeId = $("#UserRegistrationModal input[name='ProgrammeId']").val();
